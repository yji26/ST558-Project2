...
The Markdown files for each day of the week are linked below. Each day's vignette contains some exploration of the data, along with model fitting on the split training data set and model evaluation on the testing data set.
